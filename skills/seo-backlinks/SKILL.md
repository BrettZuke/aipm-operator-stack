...
- `skills/seo/references/backlink-quality.md` *(not included in this repo)* -- Detailed toxic link patterns and scoring methodology (shared reference, load when analyzing toxic links or spam scores)
- `skills/seo/references/free-backlink-sources.md` *(not included in this repo)* -- Source comparison, confidence weighting, setup guides (shared reference, load when configuring free backlink APIs)
