...
- **WORDS grouping** — 2–4 words / line, ~380–520 ms per word (premium pacing is slower than the offer strategist). Group from `transcript.json`; keep `end < next.start` (monotonic).
