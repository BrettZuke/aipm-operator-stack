...
- the offer strategist-size (~7–9% of frame) is **hook** size, not body size. Reserve for punchlines.
...
Pick **one** saturated accent per video for keyword highlights. the offer strategist yellow+green+red works for him because his content is already loud. Cinematic = single accent + white/bone/charcoal. Default palette:
