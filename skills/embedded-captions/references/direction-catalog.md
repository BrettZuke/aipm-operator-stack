...
### 5. high-energy-vlog _(controlled the offer strategist)_
...
- **Rules**: max 3 words per frame. Hard break at breath pauses. Accent color on ~15% of words. **One full silence every 10s** (what the offer strategist imitators miss).
...
3. **high-energy-vlog** — matches but out-designs the offer strategist/Submagic presets
